...
public interface IUsuarioService {
     ...
     * El usuario DEBE tener ID para poder actualizarse.
     *
    ...
    /**
     * Genera un fichero con todo el historial financiero del usuario
     * para cumplir con el derecho de portabilidad (RGPD).
     *
     ...
     *   1. Verifica que passwordAntigua coincide con la almacenada (BCrypt)
     *   2. Hashea passwordNueva con BCrypt
     *   3. Actualiza fechaUltimoCambioPassword a LocalDateTime.now()
     *
     * @param idUsuario       ID del usuario
     * @param passwordAntigua Contraseña actual en texto plano para verificar
     * @param passwordNueva   Nueva contraseña en texto plano para hashear y guardar
     * @return true si el cambio fue exitoso
     * @throws UsuarioException si la contraseña antigua es incorrecta o el usuario no existe
     */
     ...
     * Guarda los bytes de la imagen en servidor o S3 y almacena la URL resultante
     * en el campo fotoPerfil del usuario.
     *
     * @param idUsuario ID del usuario
