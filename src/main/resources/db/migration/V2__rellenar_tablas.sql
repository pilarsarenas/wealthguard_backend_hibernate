...
-- -- ==========================================
-- INSERT INTO `usuario` (
--   `contador_intentos`, `email`, `es_admin`, `fecha_registro`, 
...
-- ) VALUES 
-- (0, 'juan@email.com', 0, NOW(6), NULL, NULL, 'juan99', 'Juan', 'hash123', '¿Mascota?', 'Pérez', 'Toby', 'García'),
-- (0, 'ana.admin@email.com', 1, NOW(6), NOW(6), 'ana_avatar.png', 'anaroot', 'Ana', 'hash456', '¿Ciudad?', 'Rodríguez', 'Madrid', NULL),
-- (2, 'marta@email.com', 0, NOW(6), NULL, NULL, 'marta_dev', 'Marta', 'hash789', '¿Color?', 'Sanz', 'Verde', 'López');
